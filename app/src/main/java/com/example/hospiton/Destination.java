...
public class Destination extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        placephoto=(ImageView)findViewById(R.id.photo);
        Find=(Button)findViewById(R.id.find_photo);
        ...
        Find.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Destination.this,"Must not be null",Toast.LENGTH_SHORT).show();
                    return;
                }
                else{
                    getPhotoandDetail(place_id);
                }
            }
        });
        ...
        placeResponseTask.addOnCompleteListener(new OnCompleteListener<FindCurrentPlaceResponse>() {
            ...
            public void onComplete(@NonNull Task<FindCurrentPlaceResponse> task) {
               ...
               Log.d("main","taskcomplete");
                ...
                Toast.makeText(Destination.this,response.getPlaceLikelihoods().get(0).getPlace().getAddress(),Toast.LENGTH_LONG).show();
